...
int main(void)
{
  ...
  {
    /* USER CODE END WHILE */
	  temperature = HAL_GPIO_ReadPin(gpio_ip_GPIO_Port, GPIO_PIN_1);
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : gpio_ip_Pin Slave_select_Pin */
  GPIO_InitStruct.Pin = gpio_ip_Pin|Slave_select_Pin;
